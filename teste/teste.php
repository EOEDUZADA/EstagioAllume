...
if (isset($_POST['query'])) {
    ...
    $sql_marca = "SELECT * FROM produtos WHERE marca_produto LIKE :query";
    ...
    $stmt2 = $conn->prepare($sql_marca);
    $stmt2->bindValue(':query', '%' . $query . '%');
    $stmt2->execute();
    $results_marca = $stmt2->fetchAll();
